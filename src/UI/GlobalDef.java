...
public class GlobalDef {
	public static final Color loginGray = new Color(0xE4E4E4);
	public static final Color selecetdGray = new Color(0x949494);
	public static final Color deepPurple = new Color(0x4C5264);
	public static final String DefaultFontName = "DIN Alternate";
	public static final String TableFontName = "PingFang SC";
	public static final int bigWindowWidth = 1010;
	...
	public static final String secret = "私密管理";
